...
void main()
{
	static const char* CONSTRUCTION_DATASET = "dataset1.txt";
	static const char* VERIFICATION_DATASET = "non-elements.txt";
	static const char* OUTPUT_FILE = "output.txt";
	static const char* VERIFICATION_FILE = "OUTPUT_CORRETTO1.txt";
